...
#Bicycles
bicycle1 = Bicyle.create{position:1, number:1}
bicycle2 = Bicyle.create{position:2, number:2}
bicycle3 = Bicyle.create{position:3, number:3}
bicycle4 = Bicyle.create{position:4, number:4}
bicycle5 = Bicyle.create{position:5, number:5}
bicycle6 = Bicyle.create{position:7, number:6 }
bicycle7 = Bicyle.create{position:8, number:7}
bicycle8 = Bicyle.create{position:9, number:8}
bicycle9 = Bicyle.create{position:10, number:9}
bicycle10 = Bicyle.create{position:11, number:10}
bicycle11 = Bicyle.create{position:12, number:11}
bicycle12 = Bicyle.create{position:13, number:12}
bicycle13 = Bicyle.create{position:14, number:13}
bicycle14 = Bicyle.create{position:15, number:14}
bicycle15 = Bicyle.create{position:17, number:15}
bicycle16 = Bicyle.create{position:18, number:16}
bicycle17 = Bicyle.create{position:19, number:17}
bicycle18 = Bicyle.create{position:21, number:18}
bicycle19 = Bicyle.create{position:22, number:19}
bicycle20 = Bicyle.create{position:23, number:20}
