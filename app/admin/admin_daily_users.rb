ActiveAdmin.register Appointment, :as => "Clientes_del_dia" do 
  ...
  filter :start, :as => :date_time_range, datepicker_options: {min_date: Time.zone.now.beginning_of_day, max_date: Time.zone.now.end_of_day}
  
  filter :schedule_instructor_first_name, :as => :string
