class StreamingClassesController < ApiController
  ...
  def show
    begin
      ...
      render json: {streaming_class: @streaming_class.as_json(except: [:created_at, :updated_at, :photo_file_name, :photo_content_type, :photo_file_size, :photo_updated_at]), available_streaming_class: available_streaming_class}
    rescue Exception => e
